package com.example.swiftpay.ui.screens.withdraw.withdraw_to
...
@Composable
fun WithdrawToScreen(navController: NavController) {
...
@Composable
fun WithdrawToScreenPreview() {
    SwiftPayTheme {
        WithdrawToScreen(rememberNavController())
    }
}