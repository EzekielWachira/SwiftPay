package com.example.swiftpay.ui.screens.withdraw.receipt
...
import com.example.swiftpay.ui.screens.withdraw.receipt.components.WithdrawReceiptDetails
import com.google.accompanist.systemuicontroller.rememberSystemUiController

@Composable
fun WithdrawReceiptScreen(navController: NavController) {
    ...
    Scaffold(
        ...
        Column(
            ...
            Column(
                ...
                Text(text = "$ 2,500.00", style = MaterialTheme.typography.titleLarge,
                    color = MaterialTheme.colorScheme.inversePrimary,
                    fontSize = 30.sp)
                ...
                WithdrawReceiptDetails(modifier = Modifier.fillMaxWidth())
            }
...
@Composable
fun WithdrawReceiptScreenPreview() {
    SwiftPayTheme {
        WithdrawReceiptScreen(rememberNavController())
    }
}