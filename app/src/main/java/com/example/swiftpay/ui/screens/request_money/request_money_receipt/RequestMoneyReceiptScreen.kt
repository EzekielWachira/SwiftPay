...
@Composable
fun RequestMoneyReceiptScreen(navController: NavController) {
    ...
    Scaffold(
        ...
        Column(
            ...
            Column(
                ...
                Text(text = "$ 250.00", style = MaterialTheme.typography.titleLarge,
                    color = MaterialTheme.colorScheme.inversePrimary,
                    fontSize = 30.sp)
                ...
                Text(
                    text = "You requested to Alexia Hershey",
