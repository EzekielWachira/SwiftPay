package com.example.swiftpay.ui.screens.receipt
    ...
    Scaffold(
        ...
        Column(
            ...
            Column(
                ...
                Text(text = "$ 500.00", style = MaterialTheme.typography.titleLarge,
                    color = MaterialTheme.colorScheme.inversePrimary,
                    fontSize = 30.sp)
                ...
                ReceiptDetails(modifier = Modifier.fillMaxWidth())
            }
